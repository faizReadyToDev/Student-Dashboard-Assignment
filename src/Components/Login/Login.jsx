    ...
    return (
        ...
        {userLoggedIn && (<Navigate to={"/home"} replace={true} />)}
            <div className='h-[100vh] bg-black'>
                <div className='w-[80vw] mx-auto flex justify-center p-10 max-sm:w-[100vw] max-sm:p-0 max-sm:pt-20'>
                    <div className='flex flex-col items-center justify-center mt-30 border p-10 rounded-2xl bg-white max-sm:p-4'>
                        ...
                        <button onClick={onSubmit} className='w-[20vw] flex items-center justify-between px-1 py-2 rounded-md mb-10 bg-blue-600 cursor-pointer max-sm:w-[90vw]'>
